    ...
    <section class="category col container py-5">
        ...
        <div class="d-flex justify-content-center mt-3">
            ...
            @foreach ($categories as $category)
                <a class=" link-underline link-underline-opacity-0 col-md-3 " style="min-width: 300px;" href="#">
                    <div class="card p-1">
                        <div class="d-flex justify-content-between align-items-center p-2">
                            <div class="flex-column lh-1 imagename"> <span>{{ $category->title }}</span></div>
                            <div> <img src="/storage/category/{{ $category->thumbnail }}" height="100" width="100" /> </div>
                        </div>
                    </div>
                </a>
            @endforeach
