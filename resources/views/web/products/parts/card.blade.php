<div class="col mb-5">
    <div class="card h-100">
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
            @auth('web')
                @if ($favorite)
                    <a href="{{route('favorite.add')}}" class=" example link-underline link-underline-opacity-0 text-muted favorite_change "
                ...
                @else
                    <a href="{{route('favorite.remove')}}" class=" example link-underline link-underline-opacity-0 text-muted favorite_change add-to-favorite"
                    id ='favorite_change{{$product->id}}' data-id="{{$product->id}}">
